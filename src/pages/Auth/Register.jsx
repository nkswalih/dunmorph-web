    ...
    <div className="min-h-screen flex items-center justify-center px-6 pt-20 pb-20 bg-cream">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <p className="text-sm text-gray-500">Join the DUNMORPH community.</p>
        </div>
        ...
        <div className="bg-white p-8 md:p-10 shadow-sm border border-gray-100">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-end text-xs text-gray-500 mt-2 pb-2">
              <span>* Required</span>
            </div>
        ...
        <p className="text-center text-sm text-gray-500 mt-8">
          ...
          <Link to="/login" className="font-medium text-gray-900 hover:text-gold transition-colors duration-300 border-b border-gray-900 hover:border-gold">
            Sign in
          </Link>
        </p>
      </div>
