      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-16">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <Link to="/women" className="block text-sm text-cream/60 hover:text-cream transition-colors duration-3000">
                Women
              </Link>
              <Link to="/accessories" className="block text-sm text-cream/60 hover:text-cream transition-colors duration-3000">
                Accessories
              </Link>
              <Link to="/watches" className="block text-sm text-cream/40 cursor-not-allowed">
                Watches
              </Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <a href="#" className="block text-sm text-cream/60 hover:text-cream transition-colors duration-300">
                Contact Us
              </a>
              <a href="#" className="block text-sm text-cream/60 hover:text-cream transition-colors duration-300">
                Shipping & Returns
        ...
        <div className="mt-16 pt-8 border-t border-cream/10 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <a href="https://www.instagram.com/dunmorph.in/" className="text-cream/40 hover:text-cream transition-colors duration-300" aria-label="Instagram">
